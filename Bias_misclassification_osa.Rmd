...
We look into how misclassifications may affect the estimated effect size of a genetic variant on OSA. Mislassifications is assumed only in one direction: an individuals with OSA may not have any indication as having OSA, and is therefore misclassified as a control. For now, we ignore age effects. 
